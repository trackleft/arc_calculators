...
(function (Drupal, document, once) {
  ...
  Drupal.arcGPACalculator.addCalculatorRows = function (numberOfRowsToAdd) {
    ...
    for (var i = currentNumRows; i < numberOfRowsToAdd + currentNumRows; i++) {
      ...
      newTDCourse.innerHTML = "<input type='text' class='course-field w-100' name='course' aria-label='Course Name'>";
      newTDCourse.className = 'pr-2 pr-md-5';
      var newTDGrade = document.createElement('td');
      newTDGrade.innerHTML = "<select class='grade-field p-1' name='grade' aria-label='Course Grade'><option value=''></option><option value='4'>A</option><option value='3'>B</option><option value='2'>C</option><option value='1'>D</option><option value='0'>E</option></select>";
      var newTDCredit = document.createElement('td');
      newTDCredit.innerHTML = "<input type='number' min='0' max='100' class='credit-field text-center' name='credit' aria-label='Units of Credit'>";
